...
;
;   ── MODO TESTE (GerarCertificados_TESTE_v3) ─────────────────────────────
;   Cópia IDÊNTICA da v24 para testes e demonstrações, sem mandar e-mail
;   para docente real. Única diferença: antes de tudo pergunta um e-mail de
;   teste, e no manifesto.txt o "email" de TODOS os docentes é trocado por
;   esse e-mail (nomes, arquivos e demais campos continuam iguais). PDFs,
;   pastas, log e manifesto são gerados normalmente, como na v24.
;   Regra: toda mudança na versão oficial também é feita aqui (v25 → TESTE_v4).
...
resumoFinal := "⚠️ MODO TESTE — e-mails do manifesto: " EMAIL_TESTE "`n`n"
