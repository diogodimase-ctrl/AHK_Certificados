...
;
;   ── MODO TESTE (GerarCertificados_TESTE_v2) ─────────────────────────────
;   Cópia da v23 para testar o envio automático do Power Automate sem mandar
;   e-mail para docente real. Única diferença: antes de tudo pergunta um
;   e-mail de teste, e no manifesto.txt o "email" de TODOS os docentes é
;   trocado por esse e-mail (nomes, arquivos e demais campos continuam
;   iguais). PDFs e pastas são gerados normalmente, como na v23.
